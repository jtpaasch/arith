...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5dfe93d66646921bd076365ff4e49222) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Lexer"; "Eval"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "arith_lib";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "arith_lib"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
     ...
     oasis_digest = Some "\251.lQ\254\014\177\r\217\223e\030(\012\127\244";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
